-- ============================================================================
-- 56 · Venta Nayax descuenta inventario de tolva y vasos
--
-- Bug: las migraciones anteriores del RPC procesar_venta_nayax (recetas,
-- candado de tipo, etc.) habían perdido el descuento de inventario que
-- existía en la versión original. Las ventas se registraban con costo y
-- utilidad correctos, pero las tolvas y vaso_inventario_actual no bajaban.
--
-- Esta migración restaura el descuento en ambos caminos del RPC:
--   - tipo='polvo_directo': descuenta gramos de la tolva del PA Code
--   - tipo='preparado': descuenta gramos de cada tolva ingrediente
--   - Si la máquina vende vaso, descuenta 1 vaso en ambos caminos.
-- ============================================================================
