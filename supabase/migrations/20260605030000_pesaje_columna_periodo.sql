-- ============================================================================
-- 61 · Fix: op_registrar_pesaje_maquina usaba columnas inexistentes
--
-- Bug: en la migración anterior usé `anio` y `mes` en lugar de
-- `periodo_anio` y `periodo_mes` al buscar el cierre abierto. Resultado:
-- el pesaje fallaba con 'column "anio" does not exist'.
-- ============================================================================
